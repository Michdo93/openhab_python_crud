...
if __name__ == "__main__":
    ...
    crud.create("testItem", "String", "my test string", ["testGroup"])
    crud.create("testItem2", "Switch", "my test switch")
    crud.create("testItem3", "Number")

    testItem = crud.read("testItem")
    testItem2 = crud.read("testItem2")
    testItem3 = crud.read("testItem3")
    ...
    crud.delete("testItem2")
    crud.delete("testItem3")
